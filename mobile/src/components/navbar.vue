<template>
  <view class="">
    ...
    >
      <view class="u-status-bar" :style="{ height: statusBarHeight + 'px' }" />
    ...
    <view class="navbar-nvue-content">
      <view
        class="uvue-status-bar"
        :style="{ height: statusBarHeight + 'px' }"
      />
      <view class="uvue-navbar-inner" :style="navbarNvueStyle">
        <view v-if="isBack" class="back-warp" @tap="goBack">
          <image
            v-if="backIcon === 'black'"
            class="back-icon"
        ...
        <view class="nvue-slot-content">
          <slot />
        </view>
        <view class="nvue-slot-right">
          <slot name="right" />
        </view>
      </view>
    </view>
    <view
      v-if="isFixed && !immersive"
      class="nvue-navbar-placeholder"
      :style="{
        width: '100%',
        height: statusBarHeight + height + 'px'
      }"
    />
    <!-- #endif -->
  </view>
