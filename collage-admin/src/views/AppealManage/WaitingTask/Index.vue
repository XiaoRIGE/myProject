...
export default defineComponent({
  setup() {
    ...
    const appealTimeOrder = ref(3); //时间排序
    const queryList = async () => {
      ...
      const data = {
        ...
        size: pageSize.value,
        appealTimeOrder: appealTimeOrder.value
      };
      try {
    ...
    const tableChange = () => {
      switch (appealTimeOrder.value) {
        case 3:
          return (appealTimeOrder.value = 0), queryList();
        case 1:
          return (appealTimeOrder.value = 3), queryList();
        case 0:
          return (appealTimeOrder.value = 1), queryList();
      }
    };
